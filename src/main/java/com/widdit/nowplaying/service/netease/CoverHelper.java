...
public class CoverHelper {
     ...
     * 生成网易云音乐封面图片 URL
     *
     * URL 格式：https://p1.music.126.net/{enc}/{picId}.jpg
     *
     * @param picId 网易云音乐封面图片 ID
     * @return 封面 URL
     */
    public static String buildCoverUrl(long picId) {
        String enc = encryptId(Long.toString(picId));
     ...
     * @return 带尺寸参数的封面 URL
     */
    public static String buildCoverUrl(long picId, int size) {
